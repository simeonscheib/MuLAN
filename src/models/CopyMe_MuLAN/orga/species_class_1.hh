#ifndef UTOPIA_MODELS_SPECIES_CLASS_1_HH
#define UTOPIA_MODELS_SPECIES_CLASS_1_HH

#include "../organism.hh"

// Include all other species classes
#include "species_class_2.hh"
...
namespace MuLAN_MA {
    ...
    class species_class_2;

    // Inherit from MuLAN organism
    // TODO: change name
    template <typename DOM_T, typename PSPACE_T, int ...CFGs>
    class species_class_1: public organism<DOM_T, PSPACE_T>{

    public:

        using pp_ptr [[maybe_unused]] = boost::shared_ptr<species_class_1>;
         ...
         * @param d Domain
         */
        explicit species_class_1(DOM_T* d) : organism<DOM_T, PSPACE_T>(d) {
            // TODO: construcion
        }; // TODO: rename
         ...
         */
        explicit species_class_1(DOM_T* d, double initial_mass) : species_class_1(d) {
         ...
         */
        ~species_class_1() = default; // TODO: change name
        ...
        virtual void count(int c) override{
            ...
            species_class_1<DOM_T, PSPACE_T, CFGs...>::spec_count += c; // TODO: change name
        }
    ...
    // TODO: change name
    template <typename DOM_T, typename PSPACE_T, int ...CFGs>
    int species_class_1<DOM_T, PSPACE_T, CFGs...>::spec_count = 0;
...
#endif //UTOPIA_MODELS_SPECIES_CLASS_1_HH